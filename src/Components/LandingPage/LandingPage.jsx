    ...
    return (
        <>
            ...
            <TopSection />
             ...
             <div>
        <div id="dreamBanner">
            <h2>Dreamy Deals, That Can't Be Resisted</h2>
            <p>Don't Get Your Money Wasted</p>
            <button class="dreamBannerBtn">Shop Now</button>
        </div>
    
        <div id="buttFromInstagram">
            <h2>Buy from Instagram</h2>
        ...
        <div className="ImageOverText">
            <h2>We're committed to<br></br>become climate-<br></br>positive by 2025</h2>
